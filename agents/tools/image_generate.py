...
model_client = get_moderate_model_client()
...
async def generate_image(prompt: str) -> str:
    ...
    try:
        ...
        print(f"*********Image generated and uploaded to: {image_url}")
...
image_generation_tool = FunctionTool(
         generate_image,
        name="generate_image",
        description="Generate an image based on a text prompt using Azure OpenAI gpt-image-1 model and upload it to storage then return the image url.",
    )
